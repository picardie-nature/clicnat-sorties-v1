...
class Sortie extends clicnat_smarty {
	...
	function __construct($db) {
		...
		$this->dests_notifications = ['nicolas.damiens@picardie-nature.org','decouverte@picardie-nature.org','thomas.hermant@picardie-nature.org','yves.maquinghen@picardie-nature.org'];
	}
